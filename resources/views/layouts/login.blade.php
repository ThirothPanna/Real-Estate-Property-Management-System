<x-guest-layout>
    <div class="w-full sm:max-w-[440px]">
        ...
        <!-- Titles --><!-- Social Login Buttons -->
<div class="space-y-4 mb-8">
    <a href="{{ route('social.redirect', 'google') }}" ...>...</a>
    <a href="{{ route('social.redirect', 'apple') }}"  ...>...</a>
</div>
        ...
        <div class="space-y-4 mb-8">
            ...
            <!-- Facebook -->
            <a href="{{ route('social.redirect', 'facebook') }}" class="w-full flex items-center justify-center gap-3 px-4 py-3.5 border border-gray-200 rounded-lg hover:bg-gray-50 transition duration-200">
